...
@router.post("/token", response_model=schemas.APIResponse[schemas.Token], tags=["Users"])
...
def login_for_access_token(
    ...
    try:
        ...
        # 防范时序攻击
        hashed_password = user.hashed_password if user else security.get_password_hash("a_dummy_password_that_will_never_match")
        is_password_correct = security.verify_password(form_data.password, cast(str, hashed_password))
